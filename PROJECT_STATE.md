...
Dernière version de référence : **V6.5.8 UX focus / Kashima pad / performance architecture / enrichissement comportemental / lisibilité mobile / intégrité / fenêtres**

Ce fichier sert de **handoff** pour reprendre le projet dans un nouveau chat sans perdre les décisions structurantes.  
Avant toute modification, lire ce fichier, puis `README.md`, `QA_V6_5_8_UX_FOCUS.md`, `QA_V6_5_7_KASHIMA_PAD.md`, `QA_V6_5_6_PERFORMANCE_ARCHITECTURE.md`, `QA_V6_5_5_BEHAVIORAL_ENRICHMENT.md`, `QA_V6_5_4_MOBILE_READABILITY.md`, `QA_V6_5_INTEGRITY.md` et `QA_V6_5_1_PERFORMANCE.md`.
...
> Voici la dernière version complète de **Carnet Pêche JP V6.5.8**.  
> Commence par lire `PROJECT_STATE.md`, puis `README.md`, `QA_V6_5_8_UX_FOCUS.md`, `QA_V6_5_7_KASHIMA_PAD.md`, `QA_V6_5_6_PERFORMANCE_ARCHITECTURE.md`, `QA_V6_5_5_BEHAVIORAL_ENRICHMENT.md`, `QA_V6_5_4_MOBILE_READABILITY.md`, `QA_V6_5_3_P0_ENRICHMENT.md`, `QA_V6_5_INTEGRITY.md` et `QA_V6_5_1_PERFORMANCE.md`.  
